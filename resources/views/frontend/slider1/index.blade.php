                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-10">
                                    <strong class="card-title">Slider1</strong>
                                </div>
                                <div class="col-md-2">
                                    <a href="{{ route('slider1.create')}}" type="button" class="btn btn-block btn-success">Ajouter</a>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $slider1->id }}</td>
                                        <td><img src="https://jobsactu.com/assets/img/slider/{{ $slider1->image }}" alt="" width="60"></td>
                                        <td><a href="{{ route('slider1.edit', $slider1->id)}}" type="button" class="btn btn-primary" style="color: white"><i class="fa fa-edit"></i>&nbsp; Modifier</a>
                                            <button type="button" class="btn btn-danger" onclick="deleteData({{ $slider1->id }})"><i class="fa fa-trash-o"></i>&nbsp; Supprimer</button>
