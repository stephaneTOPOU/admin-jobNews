                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            <form action="{{ route('offre.store') }}" method="post" class="" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-3"><label for="text-input" class=" form-control-label"><strong>Lien</strong></label><input type="text" id="text-input" name="lien" placeholder="Entrer le lien où postuler.." class="form-control"></div>
                                <div class="form-group col-md-3"><label for="city" class=" form-control-label"><strong>Lieu</strong></label><input type="text" id="city" name="lieu" placeholder="Entrer le lieu" class="form-control"></div>
                                ...
                                <div class="form-group col-md-3 mt-4"> <div class="card-body"> <label class="switch switch-3d switch-success mr-3"><input type="checkbox" class="switch-input" value="1" name="valide"> <span class="switch-label"></span> <span class="switch-handle"></span></label></div> </div>
                        </div>
