                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <a href="{{ route('parametre.create')}}" type="button" class="btn btn-block btn-success">Ajouter</a>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($parametres as $parametre)
                                        <tr>
                                            ...
                                            <td>{{ $parametre->numero }}</td>
                                            <td>{{ $parametre->adresse }}</td>
                                            <td><a href="{{ route('parametre.edit', $parametre->id) }}" type="button" class="btn btn-primary" style="color: white"><i class="fa fa-edit"></i>&nbsp; Modifier</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
